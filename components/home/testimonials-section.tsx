...
const testimonials = [
  {
    ...
    quote:
      "EduGlobal made my dream of studying at Harvard a reality. Their guidance was invaluable throughout the entire process.",
    rating: 5,
    sticker: "🎉",
  },
  {
    ...
    flag: "🇬🇧",
    image: "/placeholder.svg?height=80&width=80",
    quote: "The team at EduGlobal provided exceptional support for my Oxford application. Highly recommended!",
    rating: 5,
    sticker: "🌟",
  },
  {
    ...
    flag: "🇩🇪",
    image: "/placeholder.svg?height=80&width=80",
    quote: "Thanks to EduGlobal, I am now pursuing my engineering degree in Germany with a full scholarship.",
    rating: 5,
    sticker: "🚀",
  },
]
