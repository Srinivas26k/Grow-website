...
import { universities } from "@/lib/data" // Import from centralized data

export function UniversitiesSection() {
  // Take a subset of universities for the home page
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredUniversities.map((university, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className={`card-hover ${university.color} border-2`}>
